...
export class TokenRepository
{
    ...
    {
        this.expire = GetMilliseconds(this.configService.get<string>('jwt.expires'));
        this.expireRefresh = GetMilliseconds(this.configService.get<string>('jwt.refreshExpires'));
    }
