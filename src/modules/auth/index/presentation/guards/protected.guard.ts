import { RequiredPermissionsException } from '@modules/auth/index/domain/exceptions';
import { PERMISSION_ACTION_METHOD_KEY, PermissionActions } from '@modules/auth/index/presentation/decorators';
import { CanActivate, ExecutionContext, Inject, Injectable, Logger } from '@nestjs/common';
import { ModuleRef, Reflector } from '@nestjs/core';
import { ForbiddenCustomException } from '@shared/exceptions';
import { AuthService } from '../../domain/services/auth.service';
import { RequestAuth } from '../../domain/strategies/jwt.strategy';
import { CHECK_POLICIES_KEY } from '../decorators/check-policies.decorator';
import { MANAGE_PERMISSIONS_KEY } from '../decorators/manage-permissions.decorator';
