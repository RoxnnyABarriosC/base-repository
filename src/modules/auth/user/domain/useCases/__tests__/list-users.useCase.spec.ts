...
import { MyStore, StoreModule } from '@modules/common/store';
...
describe('ListUsersUseCase', () =>
{
    ...
    let store: ClsService<MyStore>;

    const storeObject = { res: { pagination: null, metadata: null } } as MyStore;
    ...
    beforeEach(async() =>
    {
        ...
        store = app.get<ClsService<MyStore>>(ClsService);
    });
